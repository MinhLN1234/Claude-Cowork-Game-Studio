...
description: "Validate that a story file is implementation-ready before dev starts — checks embedded GDD requirements, ADR references, engine notes, clear acceptance criteria, and open design questions. Produces a READY / NEEDS WORK / BLOCKED verdict per story with a specific gap list."
---
