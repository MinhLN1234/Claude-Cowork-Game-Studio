...
description: "When a GDD is revised, scan all ADRs and the traceability index to find architectural decisions that are now potentially stale, produce a change-impact report, and guide the user through resolution. Run right after editing any GDD."
---
